...
var evaluateIfAnimatedValue=function evaluateIfAnimatedValue(key,value){
...
var evaluatedAnimatedValue=evaluateIfAnimatedValue(key,style[key]);
var value=normalizeValue(key,evaluatedAnimatedValue);

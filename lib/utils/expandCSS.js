'use strict';Object.defineProperty(exports,"__esModule",{value:true});exports.createCSSDeclarations=exports.expandStyle=undefined;var _decamelize=require('decamelize');var _decamelize2=_interopRequireDefault(_decamelize);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
...
var normalizeValue=function(property,value){
...
resolvedStyle.flexBasis='auto';}else 
if(key==='textAlignVertical'){
resolvedStyle.verticalAlign=value==='center'?'middle':value;}else 
if(expandedProps){
expandedProps.forEach(function(prop,i){
resolvedStyle[expandedProps[i]]=value;});}else 
...
var createCSSDeclarations=exports.createCSSDeclarations=function(style){return (

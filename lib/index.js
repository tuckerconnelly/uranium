...
component:(_temp=_class=function(_Component){_inherits(_class,_Component);function _class(){_classCallCheck(this,_class);return _possibleConstructorReturn(this,Object.getPrototypeOf(_class).apply(this,arguments));}_createClass(_class,[{key:'render',value:function render()




{
return component(this.props);}}]);return _class;}(_react.Component),_class.propTypes=component.propTypes,_class.defaultProps=component.defaultProps,_temp);var 



Uranium=function(_ComposedComponent){_inherits(Uranium,_ComposedComponent);function Uranium(){var _Object$getPrototypeO;var _temp2,_this2,_ret;_classCallCheck(this,Uranium);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp2=(_this2=_possibleConstructorReturn(this,(_Object$getPrototypeO=Object.getPrototypeOf(Uranium)).call.apply(_Object$getPrototypeO,[this].concat(args))),_this2),_this2.
...
{
return (0,_resolveStyles2.default)(_get(Object.getPrototypeOf(Uranium.prototype),'render',this).call(this),this._protectedForceUpdate);}}]);return Uranium;}(ComposedComponent);
